...
public class PendingOffersView extends ActivatableViewAndModel<VBox, PendingOffersViewModel> {
    ...
    @FXML
    TableView<PendingOfferListItem> tableView;
    @FXML
    TableColumn<PendingOfferListItem, PendingOfferListItem> priceColumn, deviationColumn, amountColumn, volumeColumn,
    ...
    private SortedList<PendingOfferListItem> sortedList;
    private FilteredList<PendingOfferListItem> filteredList;
    ...
    public void initialize() {
        ...
        tableView.setRowFactory(
                tableView -> {
                    final TableRow<PendingOfferListItem> row = new TableRow<>();
    ...
    protected void activate() {
        ...
        exportButton.setOnAction(event -> {
            ObservableList<TableColumn<PendingOfferListItem, ?>> tableColumns = tableView.getColumns();
            int reportColumns = tableColumns.size() - 3;    // CSV report excludes the last columns (icons)
            CSVEntryConverter<PendingOfferListItem> headerConverter = item -> {
            ...
            CSVEntryConverter<PendingOfferListItem> contentConverter = item -> {
                String[] columns = new String[reportColumns];
...
//            }
    ...
    private void applyFilteredListPredicate(String filterString) {
        filteredList.setPredicate(item -> {
            ...
            Offer offer = item.getPendingOffer();
    ...
    private void setOfferIdColumnCellFactory() {
        ...
        offerIdColumn.setCellFactory(
                new Callback<>() {
                    ...
                    @Override
                    public TableCell<PendingOfferListItem, PendingOfferListItem> call(TableColumn<PendingOfferListItem,
                            PendingOfferListItem> column) {
