...
// Taken from Tor Browser's bundled default entries: Browser/TorBrowser/Data/Browser/profile.default/preferences/extension-overrides.js
public class DefaultPluggableTransports {
    public static final List<String> OBFS_3 = Arrays.asList(
    ...
    public static final List<String> OBFS_4 = Arrays.asList(
    ...
    public static final List<String> MEEK_AMAZON = Arrays.asList("meek 0.0.2.0:2 B9E7141C594AF25699E0079C1F0146F409495296 url=https://d2cly7j4zqgua7.cloudfront.net/ front=a0.awsstatic.com");

    public static final List<String> MEEK_AZURE = Arrays.asList("meek 0.0.2.0:3 97700DFE9F483596DDA6264C4D7DF7641E1E39CE url=https://meek.azureedge.net/ front=ajax.aspnetcdn.com");
}
